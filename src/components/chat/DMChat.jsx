  ...
  return (
    <div className="h-full flex flex-col min-w-0">
      ...
      <div className="h-12 flex items-center gap-3 px-4 border-b border-[#333] bg-[#222]">
        <div className="w-8 h-8 rounded-full bg-[#2B2B2B] grid place-items-center text-gray-400">
      ...
      <form onSubmit={send} className="p-4 border-t border-[#333] bg-[#222]">
        <div className="flex items-center gap-2">
          <button type="button" className="px-2 py-2 rounded bg-[#2B2B2B] hover:bg-[#3A3A3A] text-gray-400">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" className="w-5 h-5"><path d="M12 5v14M5 12h14" /></svg>
          </button>
          <input
            value={text}
